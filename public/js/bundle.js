...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoibm15b2RhIiwiYSI6ImNsYTl2eW5naTAyOXUzb212aXNqZDE5bXYifQ.PgD7AYoxtmQJieKTd4zGHg';
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              console.log(form);
              _context.next = 8;
              return (0, _updateSettings.updateSettings)(form, 'user');
            case 8:
            case "end":
              return _context.stop();
          }
